...
import (
	...
	"github.com/khulnasoft/tunnel-operator/pkg/operator/workload"
...
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=configauditreports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=rbacassessmentreports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=infraassessmentreports,verbs=get;list;watch;create;update;patch;delete
...
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=clusterconfigauditreports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=clusterrbacassessmentreports,verbs=get;list;watch;create;update;patch;delete
