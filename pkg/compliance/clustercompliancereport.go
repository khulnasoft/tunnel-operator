...
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=clustercompliancereports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=clustercompliancereports/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=khulnasoft.github.io,resources=clustercompliancedetailreports,verbs=get;list;watch;create;update;patch;delete
