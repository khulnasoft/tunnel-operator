...
type Config struct {
	...
	ServiceAccount                               string         `env:"OPERATOR_SERVICE_ACCOUNT" envDefault:"tunnel-operator"`
	...
	BuiltInTunnelServer                           bool           `env:"OPERATOR_BUILT_IN_TUNNEL_SERVER" envDefault:"false"`
	TunnelServerHealthCheckCacheExpiration        *time.Duration `env:"TUNNEL_SERVER_HEALTH_CHECK_CACHE_EXPIRATION" envDefault:"10h"`
