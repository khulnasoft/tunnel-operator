...
[ -d $HELM_TMPDIR/trivy-operator/templates/tunnel-server ] && cat $HELM_TMPDIR/trivy-operator/templates/tunnel-server/* > $STATIC_DIR/trivy-server.yaml && cp $STATIC_DIR/trivy-server.yaml $HELM_TMPDIR/trivy-operator/templates
rm -rf $HELM_TMPDIR/trivy-operator/templates/tunnel-server
